...
_COACHING_PROMPT = ChatPromptTemplate.from_messages([
    (
        ...
        (
            ...
            "   - **경향/원칙 설명**: 그 상황에서 어떤 경향으로 말하고 행동할지 원칙을 제시 (예: '비판하기보다는 아이의 감정을 먼저 수용하는 경향으로', '지시하기보다는 공감과 이해를 표현하는 경향으로')\n"
            "   - **예시 문장 제공**: 해당 경향을 보여주는 구체적인 말문장 예시 1-2개 (예: \"예: '그런 마음이었구나, 궁금한 건 이해해' 또는 '지금 화가 많이 났구나'\")\n"
            ...
            "   - **중요**: 특정 발화를 직접적으로 '이렇게 말하세요'라고 지시하지 말고, 상황과 경향을 설명한 후 예시를 제공하는 형태로 작성할 것.\n"
            "   - 예시 형식: \"[상황 설명]에는 [경향/원칙 설명하기]. 예: '[예시 문장1]' 또는 '[예시 문장2]'\"\n"
            "   - **문체**: action 문장은 '~하기', '~하는 경향으로 대화하기'와 같이 동작 지시형으로 작성할 것. '~합니다', '~대화합니다'와 같은 서술형을 사용하지 말 것.\n"
    ...
    (
        ...
        (
            ...
            "  * 각 action은 '상황 설명 + 경향/원칙 설명하기 + 예시 문장' 형태로 구성\n"
            "  * 특정 발화를 직접적으로 '이렇게 말하세요'라고 지시하지 말고, 어떤 상황에서 어떤 경향으로 말할지 원칙을 제시한 후 예시를 제공\n"
            "  * 문체: '~하기', '~하는 경향으로 대화하기'와 같이 동작 지시형으로 작성. '~합니다', '~대화합니다'와 같은 서술형을 사용하지 말 것.\n"
            "  * 예시: \"아이가 감정을 표현할 때에는 비판하기보다는 그 감정을 먼저 수용하는 경향으로 대화하기. 예: '그런 마음이었구나, 힘들었겠네' 또는 '지금 화가 많이 났구나'\"\n"
